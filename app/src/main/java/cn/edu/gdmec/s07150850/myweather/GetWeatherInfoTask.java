package cn.edu.gdmec.s07150850.myweather;
...
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    private static String key="&key=e28e6198ecc83198f948ce2a9dd9621b";
